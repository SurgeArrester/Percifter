...
class ElementIsolator():
    def __init__(self, filepath, output_path=None):
        ...
        if output_path:
            self.write_to_file(isolated_cifs,formulaments, output_path + self.icsd_code + "/")
...
if __name__ == "__main__":
    testpath = '/home/cameron/Datasets/ICSD/ICSD_2019_Li_CIFs/icsd_977903.cif'
    output_path = '/home/cameron/Documents/tmp/icsd_977903/'
